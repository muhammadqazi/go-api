...
INSERT INTO 
    invoices_entity (invoice_id, date, amount, description, installment, term) 
VALUES 
    (1, current_timestamp, 1000, 'Monthly invoice', 1, 'Fall'),
    (2, current_timestamp, 1000, 'Monthly invoice', 1, 'Fall'),
    (3, current_timestamp, 1000, 'Monthly invoice', 1, 'Fall'),
    (4, current_timestamp, 1000, 'Monthly invoice', 1, 'Fall'),
    (5, current_timestamp, 1000, 'Monthly invoice', 1, 'Fall');

INSERT INTO payments_entity 
    (payment_id, date, amount, process_type) 
VALUES 
    (1, current_timestamp, 1000, 'Cash'),
    (2, current_timestamp, 1000, 'Check'),
    (3, current_timestamp, 1000, 'Credit card'),
    (4, current_timestamp, 1000, 'Bank transfer'),
    (5, current_timestamp, 1000, 'Paypal');
...
INSERT INTO accounting_entity
    (accounting_id, total_fee, scholarship, discount, installments, invoice_id, payment_id) 
VALUES
    (1, 10000, 1000, 500, 4, 1, 1),
    (2, 12000, 1500, 400, 5, 2, 2),
    (3, 8000, 500, 300, 3, 3, 3),
    (4, 15000, 2000, 600, 4, 4, 4),
    (5, 7000, 700, 200, 2, 5, 5);


INSERT INTO students_entity 
    (created_at, updated_at, deleted_at, is_active, first_name, surname, email, nationality, dob, place_of_birth, sex, password, role, status, semester, enrollment_date, graduation_date,student_id,is_deleted,is_graduated,faculty_id,personal_info_id,contact_info_id,address_id,accounting_id) 
VALUES 
